...
\begin{figure}[htp]
    ...
    \end{tikzpicture}\caption{Stern-Gerlach Experiment. Figured designed by \href{http://clemens.koppensteiner.site}{Clemens Koppensteiner}.}\label{fig:stern_gerlach}\end{figure}
\begin{note}
