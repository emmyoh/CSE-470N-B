    ...
    \begin{tikzpicture}[shorten >=4pt,node distance=3cm,on grid,auto]
        ...
        \path[-latex,shorten >= 2pt, shorten <= 2pt]
            (a_left)
                edge node {} (a)
            (a)
                edge node {$\downarrow \ 50\%$} (a_below)
                edge node {$\uparrow \ 50\%$} (b)           
            (b)
                edge node {$\downarrow \ 100\%$} (b_below)
                edge node {$\uparrow \ 0\%$} (b_right);
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[shorten >=4pt,node distance=3cm,on grid,auto]
        ...
        \path[-latex,shorten >= 2pt, shorten <= 2pt]
            ...
            (a)
                ...
                edge node {$\uparrow \ 50\%$} (b)           
            (b)
                edge node {$\leftarrow \ 50\%$} (b_below)
                edge node {$\rightarrow \ 50\%$} (c)
            (c)
                edge node {$\downarrow \ 50\%$} (c_below)
                edge node {$\uparrow \ 50\%$} (c_right);
    \end{tikzpicture}
