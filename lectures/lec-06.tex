...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[shorten >=1pt,node distance=3.5cm,on grid,auto]
        ...
        \node[] (a_left) [left=of a] {\begin{adjustbox}{width=3cm}$\ket{v} = \frac{1}{\sqrt{2}}\cdot\begin{bmatrix}0\\1\end{bmatrix} + \frac{1}{\sqrt{2}}\cdot\begin{bmatrix}1\\0\end{bmatrix}$\end{adjustbox}};
        ...
        \path[-latex,shorten >= 2pt, shorten <= 2pt]
            ...
            (a)
                edge node {} (a_below)
                edge node {\begin{adjustbox}{width=1cm}Through $\begin{bmatrix}1\\0\end{bmatrix}$\end{adjustbox}} (b)           
            (b)
                edge node {} (b_below)
                edge node {\begin{adjustbox}{width=1cm}$\begin{bmatrix}\frac{1}{\sqrt{2}}\\-\frac{1}{\sqrt{2}}\end{bmatrix}$\end{adjustbox}} (c)
            (c)
